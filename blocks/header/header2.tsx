        ...
        >
            ...
            <div className="container relative mx-auto min-h-20 flex items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center space-x-2">
                        <div className="w-8 h-8  rounded-md flex items-center justify-center">
                            <span className="text-primary-foreground font-bold text-sm">
                                <Image
                                    src="/posadzkizywiczne.com_logo.png"
                                    alt="logo posadzkizywiczne.com"
                                    width={300}
                                    height={100}
                                    sizes="32px"
                                />
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <Link href="/wyniki-konkursu" className="flex items-center gap-2">
                            <span className="hidden sm:inline">Zobacz wyniki konkursu</span>
                            <span className="sm:hidden">Wyniki konkursu</span>
                        </Link>
                    </Button>
                </div>

# Przykładowy folder realizacji

Ten folder pokazuje jak powinna wyglądać struktura dla realizacji.

## Zawartość:
- `opis.json` - Plik z danymi o projekcie
- Tutaj dodaj zdjęcia realizacji (*.jpg, *.png, *.webp)

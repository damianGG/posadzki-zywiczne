...
import { ImageIcon, Share2, ArrowRight, Calculator, Images, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Shop Card */}
          <Link href="/admin/sklep">
            <Card className="p-6 hover:shadow-xl transition-all cursor-pointer group">
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-rose-100 dark:bg-rose-900/30 rounded-lg group-hover:bg-rose-200 transition-colors">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Zarządzaj produktami, zestawami pod metraż i ręcznymi rekomendacjami dla sklepu.
              </p>
            </Card>
          </Link>
        </div>
